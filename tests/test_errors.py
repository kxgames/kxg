...
kxg.errors.ApiUsageError: Lorem ipsum: 33.33%'''
    ...
    assert exc.exconly() == '''\
kxg.errors.ApiUsageError: lorem ipsum dolor sit amet, consectetur adipiscing
elit.'''
